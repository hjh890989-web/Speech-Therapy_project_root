# Home Language Coaching Platform PRD v0.2 — Opus Edition
...
### 2.3 CJM 단계별 Pain·Needs ↔ 제품 개입 매핑
...
| §3 사용자 스토리 | JTBD 분석, AOS/DOS 매트릭스 | 5개 스토리 × AC의 정량 임계치 |
...
*본 PRD는 `39_VPS_V09_final_UX_reinforce.md`를 Single Source of Truth로 하여, 5대 규칙(Pain 수치화, JTBD→Given-When-Then, 북극성/보조 KPI, 대안 대비 정량 비교, 실험 설계×측정 도구 연결)을 준수하여 작성되었습니다. (작성일: 2026. 5. 7.)*
