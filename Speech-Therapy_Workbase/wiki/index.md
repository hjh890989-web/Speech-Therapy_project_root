...
| [[clinical/concepts/읽기-선행지표-발달규준]] | synthesis | 🆕 **56차 신규** — 외부 임상 KB(my-healthcare-workbase) 선별 이식. 음운인식(4세50%→5세80%·음소5세후반50%·r=.676)·해독(Simple View·β·일치/불일치)·RAN(자극유형 반응성 S133)·유창성(β·1분음절)·음운규칙(경음94%>구개음20%·오류역전)·추론(유형위계·배경지식) **연령 규준·난이도 위계**. **CL-08~11 게임 grounding**. ⚠️ 만2~4세·절단점=자체 파일럿 |
...
| [[clinical/sources/2026-06-09-S003-음운인식-읽기중재-강의]] | lecture | — | 🆕 **56차** (외부 KB→1차 승격) — 음운인식 발달 위계(음절분절 4세50%→5세80%·음소 5세후반 50%)·자소-음소 일치/불일치·음운규칙 지도순서(7종성→연음화→경음화→ㅎ탈락). CL-08/09 |
| [[clinical/sources/2026-06-09-S006-읽기평가도구-RA-RCP-BASA-EL]] | lecture | — | 🆕 **56차** — RA-RCP(읽기성취+인지처리 RAN·음운기억) + BASA-EL(만4세+ 초기문해 음운인식·RAN). CL-08~10 측정틀 |
| [[clinical/sources/2026-06-09-S090-읽기이해-예측-해독-유창성]] | paper | 2016 | 🆕 **56차** (설아영, 479명) — Simple View. 저학년 읽기부진 해독 β=.287·중학년 유창성 β=.346·고학년 일반 β=.522·해독↔유창성 r=.788(자동화 미완성). CL-09/10 |
| [[clinical/sources/2026-06-09-S113-철자쓰기-발달-음운규칙]] | paper | 2020 | 🆕 **56차** (고은이, 60명) — 음운규칙 철자 정확률 경음화94%>연음화88%>격음화73%>종성69%>구개음화20%(8세+ 지속). 음운처리오류 1-2학년 급감. F4/CL-09 |
| [[clinical/sources/2026-06-09-S133-음운인식-작업기억-훈련]] | paper | 2016 | 🆕 **56차** (김지윤) — 음운인식+작업기억 24회기 효과. RAN 자극유형 반응성(사물-4.25·글자-3.23·색깔-1.18 유의 / **숫자-0.68 비유의**). 음운처리 3요소 독립. CL-10 |
| [[clinical/sources/2026-06-09-S160-어휘력-음운인식-철자]] | paper | 2020 | 🆕 **56차** (도신애, ✅원문검증) — 음운인식↔철자 r=.676 > 어휘↔철자 r=.435(.322는 어휘↔음운인식, 외부KB 오귀속 정정). 어휘×음운인식 2×2 위험군. **오류 역전**(정상=소리나는대로 최고/D-VPA 0%, 생략·대치=위험). CL-08/F4 |
| [[clinical/sources/2026-06-09-S181-LSSC-KORLA-평가]] | lecture | 2019 | 🆕 **56차** (✅원문검증) — LSSC + KORLA(=KOLRA) 해독(의미/무의미·일치/불일치) 실시·채점, 소검사별 연속 오반응 중단(연속 6~8, 외부KB '5문항' 정정). CL-09 |
