<!--
Source: github.com/wild-mental/goal-setting-skill — .cursor/skills/goal-setting/SKILL.md
License: MIT (Copyright (c) wild-mental / bjpark) — see LICENSE-goal-setting-skill.md
Integrated into Speech-Therapy harness 2026-06-01 (SKILL.md only, per author 'curl-only' guidance).
-->
